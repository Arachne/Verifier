...
class VerifierMacros extends MacroSet
{
	...
	public static function install(Compiler $compiler)
	{
		...
		$me->addMacro('ifLinkVerified', '$_l->verifiedLink = $_presenter->link(%node.word, %node.array?); if (!$_presenter->getLastCreatedRequest() || $_presenter->getContext()->getByType(\'Arachne\Verifier\Verifier\')->isLinkAvailable($_presenter->getLastCreatedRequest())):', 'endif');
