...
class AnnotationsRuleProviderTest extends Test
{
	...
	{
		$reflection = new ReflectionClass('Arachne\Tests\Verifier\Unit\Classes\TestPresenter');
	...
	{
		$reflection = new ReflectionMethod('Arachne\Tests\Verifier\Unit\Classes\TestPresenter', 'renderView');
		$request = Mockery::mock('Nette\Application\Request');
